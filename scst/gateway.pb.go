...
type AddSVDReq struct {
	...
	LunName           string `protobuf:"bytes,1,opt,name=LunName,proto3" json:"LunName,omitempty"`                     // lun name
	LunDeviceFullPath string `protobuf:"bytes,2,opt,name=LunDeviceFullPath,proto3" json:"LunDeviceFullPath,omitempty"` // lun device(file) real path
	VID               string `protobuf:"bytes,3,opt,name=VID,proto3" json:"VID,omitempty"`                             // vendor id
	PID               string `protobuf:"bytes,4,opt,name=PID,proto3" json:"PID,omitempty"`                             // product id
	USN               string `protobuf:"bytes,5,opt,name=USN,proto3" json:"USN,omitempty"`                             // unique serial number
	HandlerType       string `protobuf:"bytes,6,opt,name=HandlerType,proto3" json:"HandlerType,omitempty"`             // handler type should be vdisk_blockio || vdisk_fileio
}
...
type RemoveSVDReq struct {
	...
	LunName     string `protobuf:"bytes,1,opt,name=LunName,proto3" json:"LunName,omitempty"`         // lun name
	HandlerType string `protobuf:"bytes,2,opt,name=HandlerType,proto3" json:"HandlerType,omitempty"` // handler type should be vdisk_blockio || vdisk_fileio
}
...
type AddGroupReq struct {
	...
	TargetName string `protobuf:"bytes,1,opt,name=TargetName,proto3" json:"TargetName,omitempty"` // target name
	TargetType string `protobuf:"bytes,2,opt,name=TargetType,proto3" json:"TargetType,omitempty"` // target type should be iscsi || qla2x00t
	GroupName  string `protobuf:"bytes,3,opt,name=GroupName,proto3" json:"GroupName,omitempty"`   // storage group name
}
...
type AddLun2GroupReq struct {
	...
	TargetType string `protobuf:"bytes,2,opt,name=TargetType,proto3" json:"TargetType,omitempty"` // target type should be iscsi || qla2x00t
	GroupName  string `protobuf:"bytes,3,opt,name=GroupName,proto3" json:"GroupName,omitempty"`   // storage group name
	LunName    string `protobuf:"bytes,4,opt,name=LunName,proto3" json:"LunName,omitempty"`       // lun name
}
...
type AddIni2GroupReq struct {
	...
	TargetType string `protobuf:"bytes,2,opt,name=TargetType,proto3" json:"TargetType,omitempty"` // target type should be iscsi || qla2x00t
	GroupName  string `protobuf:"bytes,3,opt,name=GroupName,proto3" json:"GroupName,omitempty"`   // storage group name
	Ini        string `protobuf:"bytes,4,opt,name=Ini,proto3" json:"Ini,omitempty"`               // initiator name
}
...
type SCSTResp struct {
	...
	Code int32  `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"` // 0: success, other: failed
